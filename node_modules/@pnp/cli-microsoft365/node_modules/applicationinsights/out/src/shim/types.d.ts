...
export declare type AzureFnContext = AzureFnV3Context | AzureFnV4Context;
export declare type AzureFnRequest = AzureFnV3Request | AzureFnV4Request;
export declare type AzureFnTraceContext = AzureFnV3TraceContext & AzureFnV4Context["traceContext"];
