...
class AgentLoader {
    ...
    _detectOpenTelemetryGlobals() {
        ...
        try {
            ...
            const otelGlobal = global[otelSymbolV1] || global[otelSymbolV2];
            if (otelGlobal) {
                // Check for registered TracerProvider
                if (otelGlobal["trace"]) {
                    const traceProviderName = (_b = (_a = otelGlobal["trace"]) === null || _a === void 0 ? void 0 : _a.constructor) === null || _b === void 0 ? void 0 : _b.name;
                    // ProxyTracerProvider wraps the real provider - check the delegate
                    if (traceProviderName === 'ProxyTracerProvider') {
                        const delegateName = (_e = (_d = (_c = otelGlobal["trace"]) === null || _c === void 0 ? void 0 : _c._delegate) === null || _d === void 0 ? void 0 : _d.constructor) === null || _e === void 0 ? void 0 : _e.name;
                ...
                if (otelGlobal["metrics"] && ((_g = (_f = otelGlobal["metrics"]) === null || _f === void 0 ? void 0 : _f.constructor) === null || _g === void 0 ? void 0 : _g.name) !== 'ProxyMeterProvider' && otelGlobal["metrics"].constructor.name !== 'NoopMeterProvider') {
            ...
            const logsGlobal = global[logsSymbol];
            if (typeof logsGlobal === 'function') {
                ...
                if (!logsProvider || ((_h = logsProvider.constructor) === null || _h === void 0 ? void 0 : _h.name) === 'NoopLoggerProvider') {
                    logsProvider = logsGlobal(2); // Try v2 if v1 returns NOOP
                }
                const loggerProviderName = (_j = logsProvider === null || logsProvider === void 0 ? void 0 : logsProvider.constructor) === null || _j === void 0 ? void 0 : _j.name;
                if (loggerProviderName &&
            ...
            if (detectedProviders.length > 0 && this._diagnosticLogger) {
                ...
                const diagnosticLog = {
                    message: msg,
                    messageId: types_1.DiagnosticMessageId.openTelemetryConflict
                };
                this._diagnosticLogger.logMessage(diagnosticLog);
            }
        }
