...
export declare class AgentLoader {
    ...
    private _aadCredential;
    constructor();
    private _getInstrumentationKey;
    setLogger(logger: IDiagnosticLogger): void;
    initialize(): void;
    private _validate;
    private _detectOpenTelemetryGlobals;
    private _getAuthenticationCredential;
    private _sdkAlreadyExists;
}
