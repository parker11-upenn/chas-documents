...
export declare type AvailabilityData = MonitorDomain & {
...
export declare type TelemetryEventData = MonitorDomain & {
...
export declare type TelemetryExceptionData = MonitorDomain & {
...
export declare type MessageData = MonitorDomain & {
    /** Trace message */
    message: string;
...
export declare type MetricsData = MonitorDomain & {
...
export declare type PageViewData = MonitorDomain & {
...
export declare type PageViewPerfData = MonitorDomain & {
    /** Identifier of a page view instance. Used for correlation between page view and other telemetry items. */
    id: string;
    /** Event name. Keep it low cardinality to allow proper grouping and useful metrics. */
    name: string;
...
export declare type RemoteDependencyData = MonitorDomain & {
...
export declare type RequestData = MonitorDomain & {
 ...
 * **Aggregation**
 */
export declare type DataPointType = string;
 ...
 * **Critical**
 */
export declare type SeverityLevel = string;
 ...
 */
export declare type ContextTagKeys = string;
/** Contains response data for the track operation. */
export declare type TrackOperationResponse = TrackResponse;
