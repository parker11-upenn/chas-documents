...
import { FN002010_DEVDEP_microsoft_rush_stack_compiler_2_7 } from "./rules/FN002010_DEVDEP_microsoft_rush_stack_compiler_2_7.js";
...
export default [
    ...
    new FN001026_DEP_microsoft_sp_extension_base('1.8.2'),
    new FN001027_DEP_microsoft_sp_http('1.8.2'),
    new FN001028_DEP_microsoft_sp_list_subscription('1.8.2'),
    new FN001029_DEP_microsoft_sp_loader('1.8.2'),
    new FN001030_DEP_microsoft_sp_module_interfaces('1.8.2'),
    new FN001031_DEP_microsoft_sp_odata_types('1.8.2'),
    new FN001032_DEP_microsoft_sp_page_context('1.8.2'),
...
//# sourceMappingURL=upgrade-1.8.2.js.map