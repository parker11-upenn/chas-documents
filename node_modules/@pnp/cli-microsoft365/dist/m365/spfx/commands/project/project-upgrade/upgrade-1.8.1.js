...
export default [
    ...
    new FN001023_DEP_microsoft_sp_component_base('1.8.1'),
    new FN001024_DEP_microsoft_sp_diagnostics('1.8.1'),
    new FN001025_DEP_microsoft_sp_dynamic_data('1.8.1'),
    new FN001026_DEP_microsoft_sp_extension_base('1.8.1'),
    new FN001027_DEP_microsoft_sp_http('1.8.1'),
    new FN001028_DEP_microsoft_sp_list_subscription('1.8.1'),
    new FN001029_DEP_microsoft_sp_loader('1.8.1'),
    new FN001030_DEP_microsoft_sp_module_interfaces('1.8.1'),
    new FN001031_DEP_microsoft_sp_odata_types('1.8.1'),
    new FN001032_DEP_microsoft_sp_page_context('1.8.1'),
...
//# sourceMappingURL=upgrade-1.8.1.js.map