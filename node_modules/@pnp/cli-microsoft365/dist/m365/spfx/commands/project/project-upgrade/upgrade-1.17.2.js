...
export default [
    new FN001001_DEP_microsoft_sp_core_library('1.17.2'),
    new FN001002_DEP_microsoft_sp_lodash_subset('1.17.2'),
    new FN001003_DEP_microsoft_sp_office_ui_fabric_core('1.17.2'),
    new FN001004_DEP_microsoft_sp_webpart_base('1.17.2'),
    new FN001011_DEP_microsoft_sp_dialog('1.17.2'),
    new FN001012_DEP_microsoft_sp_application_base('1.17.2'),
    new FN001014_DEP_microsoft_sp_listview_extensibility('1.17.2'),
    new FN001021_DEP_microsoft_sp_property_pane('1.17.2'),
    new FN001023_DEP_microsoft_sp_component_base('1.17.2'),
    new FN001024_DEP_microsoft_sp_diagnostics('1.17.2'),
    new FN001025_DEP_microsoft_sp_dynamic_data('1.17.2'),
    new FN001026_DEP_microsoft_sp_extension_base('1.17.2'),
    new FN001027_DEP_microsoft_sp_http('1.17.2'),
    new FN001028_DEP_microsoft_sp_list_subscription('1.17.2'),
    new FN001029_DEP_microsoft_sp_loader('1.17.2'),
    new FN001030_DEP_microsoft_sp_module_interfaces('1.17.2'),
    new FN001031_DEP_microsoft_sp_odata_types('1.17.2'),
    new FN001032_DEP_microsoft_sp_page_context('1.17.2'),
    new FN001013_DEP_microsoft_decorators('1.17.2'),
    new FN001034_DEP_microsoft_sp_adaptive_card_extension_base('1.17.2'),
    new FN001035_DEP_fluentui_react('7.199.1'),
    new FN002022_DEVDEP_microsoft_eslint_plugin_spfx('1.17.2'),
    new FN002023_DEVDEP_microsoft_eslint_config_spfx('1.17.2'),
    new FN002001_DEVDEP_microsoft_sp_build_web('1.17.2'),
    new FN002002_DEVDEP_microsoft_sp_module_interfaces('1.17.2'),
