...
export class StandardWebPartUtils {
    static getWebPartId(type) {
        const foundWebParts = StandardWebParts.filter((wp) => wp.name === type);
        return foundWebParts.length > 0 ? foundWebParts[0].id : null;
    }
    static isValidStandardWebPartType(type) {
        return StandardWebPartUtils.getWebPartId(type) !== null;
    }
}
//# sourceMappingURL=StandardWebPartTypes.js.map