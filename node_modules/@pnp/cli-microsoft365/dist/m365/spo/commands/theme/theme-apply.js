...
var _SpoThemeApplyCommand_instances, _SpoThemeApplyCommand_initOptions, _SpoThemeApplyCommand_initValidators;
...
class SpoThemeApplyCommand extends SpoCommand {
    ...
    constructor() {
        super();
        _SpoThemeApplyCommand_instances.add(this);
        __classPrivateFieldGet(this, _SpoThemeApplyCommand_instances, "m", _SpoThemeApplyCommand_initOptions).call(this);
        __classPrivateFieldGet(this, _SpoThemeApplyCommand_instances, "m", _SpoThemeApplyCommand_initValidators).call(this);
    }
    async commandAction(logger, args) {
        const isSharePointTheme = args.options.sharePointTheme ? true : false;
        try {
            ...
            let requestOptions = {};
            if (isSharePointTheme) {
                const requestBody = this.getSharePointTheme(args.options.name);
                requestOptions = {
...
_SpoThemeApplyCommand_instances = new WeakSet(), _SpoThemeApplyCommand_initOptions = function _SpoThemeApplyCommand_initOptions() {
...
}, _SpoThemeApplyCommand_initValidators = function _SpoThemeApplyCommand_initValidators() {
...
//# sourceMappingURL=theme-apply.js.map